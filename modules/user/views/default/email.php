...
<div class="row h-100 justify-content-center">
    ...
    <div class="col-md-10 col-lg-10 col-xl-8 align-self-center login--form">
        ...
        <div class="col-lg-10 push-lg-1 col-xl-8 push-xl-2">
            ...
            <?php $form = ActiveForm::begin(['id' => 'form-email-bi', 'options' => ['class' => 'col-form'], 'enableClientValidation' => false]); ?>
                ...
                <div>
                    <?= Html::submitButton('Enviar', ['class' => 'btn btn-block btn-lg btn-primary text-uppercase p-4 btn-login', 'name' => 'login-button']) ?>
                </div>
